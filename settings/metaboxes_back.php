...
require_once(TEMPLATEPATH.'/includes/helpers/admin_helper.php');
require_once(TEMPLATEPATH.'/includes/libraries/sg_metabox.php');
...
$sample_box = new sg_metabox('sample_box', 'Sample Box', $fields, 'page', true);