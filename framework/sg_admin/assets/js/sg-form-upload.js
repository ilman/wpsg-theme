jQuery(document).ready(function($) {
   ...
   $(document).on('click', '.media-upload-btn', function(event) {
      var $this = $(this);
      var $parent = $this.closest('.input-file-upload');
      var $upload_field = $parent.find('.media-upload-url');
      var $this_frame = {
      ...
      custom_file_frame.on('select', function() {
         ...
         $parent.siblings('.media-upload-preview').html('<img src="'+$upload_field.val()+'" />');
      });
