...
<ul class="post-list list-column ea-list-column row">
	<?php foreach($result as $row): ?>
		<?php 
			...
			$prop_link     = site_url('resales-property-details/?query_id='.SG_Util::val($query_info,'query_id').'&ref_id='.SG_Util::val($row,'ref'));
		...
		<li <?php post_class('post-item col-sm-'.$col_width); ?>>
			<div class="block block-box block-property bg-gray">
				...
				<div class="block-body">
					...
					<div class="property-price pull-right"><?php echo str_replace('Â','','&pound;'.$prop_price) ?></div>
