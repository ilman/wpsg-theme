...
?><div id="composite_summary_<?php echo $product->id; ?>" class="composite_summary <?php echo esc_attr( $summary_classes ); ?>" data-columns="<?php echo esc_attr( $summary_columns ); ?>"><?php

	if ( $product->get_composite_layout_style_variation() === 'componentized' ) {

		?><h2 class="summary_title component_title"><?php
			echo __( 'Choose Your Bundles', 'woocommerce-composite-products' );
		?></h2><?php
