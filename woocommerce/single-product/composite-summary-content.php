						...
						<div class="summary_element_image summary_element_data">
							<?php
								...
								if($kwirk_product_template){
									...
									echo str_replace(plugins_url('woocommerce-composite-products/assets/images/placeholder.png'), sg_asset_url('front/assets/images/placeholder-'.$kwirk_template_name.'.jpg'), $product->get_component_image( $component_id ));
								}
								else{
									$product->get_component_image( $component_id );
								}
